    ...
    <div class="content">
      ...
      <div class="container-fluid">
        <div class="row text-center ml-1 mr-1">
          ...
          <div class="col col-6 actv_2">
            <a href="home.php">active</a>
          </div>
          <div class="col col-6 dltd_2">
            <a href="deleted.php">deleted</a>
          </div>
          <div class="maincnt_2 text-left pl-5 pr-5 pb-3 pt-3">
            <table class="tbl_2">
              <?php if(isset($_POST['search'])): ?>
                <?php
                if(!empty($_POST['first_name'])){
                  $data = del_firstname_p();
                ...
                <?php foreach($data as $row => $value): ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a class="edit" href="recover.php?id=<?php echo $value['id']; ?>">recover</a>
                      </td>
                    </tr>
                  </tbody>
                <?php endforeach; ?>
              <?php else: ?>
                <?php foreach($letters as $letter): ?>
                  <?php if(del_not_empty($letter)): ?>
                    <thead>
                      <tr>
                        <th>#<?php echo $letter; ?></th>
                      </tr>
                    </thead>
                    <?php $data = del_starts_with($letter); ?>
                    <?php foreach($data as $row => $value): ?>
                      <tbody>
                        <tr>
                          <td><?php echo $value['last_name']." ".$value['first_name']; ?></td>
